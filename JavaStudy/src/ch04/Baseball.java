...
public class Baseball {
	public static void main(String[] args) {
		...
		if (inputNumber1 == baseball1) {// strike
			strike++;
		} else if (inputNumber1 == baseball2 || inputNumber1 == baseball3 ) {// ball
			ball++;
		} 
		
		if (inputNumber2 == baseball2) {// strike
			strike++;
		} else if (inputNumber2 == baseball1 || inputNumber2 == baseball3 ) {// ball
			ball++;
		} 
		
		if (inputNumber3 == baseball3) {// strike
			strike++;
		} else if (inputNumber3 == baseball1 || inputNumber3 == baseball2 ) {// ball
			ball++;
		} 
